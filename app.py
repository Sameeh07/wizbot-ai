...
If the user asks any questions related to mental health, respond like a professional mental health counselor or therapist. 
Be empathetic, supportive, and avoid any clinical or robotic tone. Offer comfort, reassurance, and gentle guidance without giving direct medical advice or diagnosis.
"""
...
iface = gr.Interface(
    ...
    inputs=[
        gr.Audio(sources=["microphone"], type="filepath"),
        gr.Image(sources=["upload", "clipboard", "webcam"], type="filepath", label="Upload an image (optional)")
    ],
    outputs=[
        gr.Textbox(label="Speech to Text"),
        gr.Textbox(label="Doctor's Response"),
